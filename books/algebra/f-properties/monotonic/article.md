...
@gallery
    images:
        -   src: images/pairs-behaviour/f-pair-increase.svg
            caption: Увеличение значения
            invertible: true
            _classList: ['w5']

        -   src: images/pairs-behaviour/f-pair-decrease.svg
            caption: Уменьшение значения
            invertible: true
            _classList: ['w5']

        -   src: images/pairs-behaviour/f-pair-const.svg
...
{ .w5 }
@image
    src: images/f-wrong-example.svg
    invertible: true
...
@gallery
    images:
        -   src: images/increasing.svg
            caption: Возрастающая (неубывающая) функция
            invertible: true
            _classList: ['w5']

        -   src: images/increasing-strict.svg
...
{ .w6 }
@image
    src: images/increasing-details.svg
    invertible: true
...
@definition
    ...
    showTitle: false
    content: |
        Функция $f(x)$ на промежутке $M\subseteq \R$ называется **возрастающей** или **неубывающей**, когда для любых двух чисел $x_1, x_2 \in M$ этого промежутка, таких, что $x_1 < x_2$, выполняется неравенство $f(x_1) \leq f(x_2)$.
...
@definition
    ...
    showTitle: false
    content: |
        Функция $f(x)$ на промежутке $M\subseteq \R$ называется **строго возрастающей**, когда для любых двух чисел $x_1, x_2 \in M$ этого промежутка, таких, что $x_1 < x_2$, выполняется неравенство $f(x_1) < f(x_2)$.
...
@gallery
    images:
        -   src: images/decreasing.svg
            caption: Убывающая (невозрастающая) функция
            invertible: true
            _classList: ['w5']

        -   src: images/decreasing-strict.svg
...
@definition
    ...
    showTitle: false
    content: |
        Функция $f(x)$ на промежутке $M\subseteq \R$ называется **убывающей** или **невозрастающей**, когда для любых двух чисел $x_1, x_2 \in M$ этого промежутка, таких, что $x_1 < x_2$, выполняется неравенство $f(x_1) \geq f(x_2)$.
...
@definition
    ...
    showTitle: false
    content: |
        Функция $f(x)$ на промежутке $M\subseteq \R$ называется **строго убывающей**, когда для любых двух чисел $x_1, x_2 \in M$ этого промежутка, таких, что $x_1 < x_2$, выполняется неравенство $f(x_1) > f(x_2)$.
...
@example
    ...
    solution: |
        По [определению](/algebra/abs/abs-function) функции модуля:
...
@example
    ...
    solution: |
        ...
        { .w5 }
        @image
            src: images/inverse-not-monotonic-example.svg
            invertible: true
...
@example
    ...
    solution: |
        ...
        Из [упражнения](e:monotonic-down) по исследованию на невозрастание вспоминаем, что функция $\frac{1}{x}$ строго убывает на положительной полуоси, а значит и на отрезке $[1,5]$.
        Из [ислледования](e:monotonic-up) на неубывание помним, что $x^2$ строго возрастает на $[0, +\infty)$, а значит и на $[1,5]$. Но в нашем случае мы умножаем эту функцию на $-1$,
