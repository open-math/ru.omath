...
@todo
    title: Алан Тьюринг — брутфорс и изобретение компьютеров
    content: |
        Рассказать про то, что англичане пытались вручную подобрать правильный шифр, чтобы рассшифровывать сообщения немцев во Второй мировой войне.
        Вручную они не успевали, поэтому Алан забахал первый в мире компьютер, который перебирал шифры быстрее человека.
        Потом пошли моральные проблемы.
        Допустить потопление корабля, тем самым не дав немцам понять, что шифр взломан.
