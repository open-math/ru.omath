...
@task
    ...
    solution: |
        Сначала разберем вариант, когда один из городов становится своеобразным "центром" и связан авиалиниями со всеми остальными городами.
        Любой из четырех городов может быть таким "центром", поэтому получаем $4$ способа проложить авиалинии.

        Все комбинации двух дву-центров (6). Каждый можно завершить 2-мя способами.
...
@task
    ...
    solution: |
        @todo
            title: Добавить короткое решение через троичную систему!
