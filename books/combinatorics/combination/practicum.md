...
@task
    ...
    solution: |
        ...
        Но каждая из этих точек пересечения [имеет](spoiler) свой дубликат для случая, когда мы выбрали те же две прямые, но в обратном порядке.
...
@task
    ...
    solution: |
        В условии говорится, что были выписаны все сочетания.
        Найдем, сколько их по [формуле](^combinationsRepeat) сочетаний с повторениями:
