...
Возможно, вы еще не до конца осознали, насколько мощный инструмент только что получили.
Больше нет необходимости долго и нудно вручную умножать друг на друга двучлены!
Проверим формулу в деле!
...
Как пример такого "мостика", с помощью бинома Ньютона можно [найти](article|applications/power-sum) общие формулы для решения очень красивой задачи о суммах степеней натуральных чисел (и не только чисел):
