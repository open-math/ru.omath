...
Если эти рассуждения записать строгим языком, то мы получим правило умножения (или правило прозведения) -- одно из самых важных правил в комбинаторике.
...
{ .w8 }
@image
    src: images/galactic-trip-more.svg
...
@example
    ...
    solution: |
        ...
        Применив правило умножения мы среди $20$ планов в том числе получили и план "1. Помочь сестре; 2. Сделать домашнее задание".
