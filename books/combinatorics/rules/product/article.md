...
На нем основан вывод многих других формул в этой науке.
...
@example
    ...
    expand: |
        ...
        Вне зависимости от первого выбора, вторую пиццу можно отдать любому из четырех оставшихся, поэтому во втором кружке $4$ и так далее.
...
@important
    title: Суть метода
    content: |
        В задачах на правило умножения можно напрямую изобразить вакантные места, внутрь которых затем вписать количество элементов, которые эти вакантные места могут занять. Полученная цепочка чисел и будет искомой цепочкой умножений.
...
@example
    title: План на день
    task: |
        У Виктора есть список дел: убраться в комнате, сделать домашнее задание, подстричь газон, помочь сестре на работе, выучить новую тему по комбинаторике. За день он может сделать два дела, но если он сначала поможет сестре на работе, то точно не успеет сделать домашнее задание. Сколько есть способов составить план на день?
    solution: |
        ...
        Применив правило умножения мы среди $20$ планов в том числе получили и такой план:

        1. Помочь сестре
        2. Сделать домашнее задание

        А из условия мы знаем, что домашнее задание он сделать не успеет, если сначала поможет сестре.
        Этот план учитывать нельзя. Поэтому правильный ответ у этой задачи -- $19$.
