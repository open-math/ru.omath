...
@task
    ...
    solution: |
        ...
        Это значит, что число $49!$ в теории может $22$ раза поделиться на $12$, если для каждой из этих $22$ троек мы найдем по две двойки.
        ...
        Значит, $49!$ делится на $12$ все $22$ раза.
    answer: |
        $22$ раза. 
