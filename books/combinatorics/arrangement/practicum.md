...
@task
    ...
    solution: |
        ...
        $$ \overline{A}_2^6 = 2^6 = 64 $$
    answer: $\overline{A}_2^6 = 64$
    similar:
        -   statement: |
        ...
        -   statement: |
            ...
            solution: |
                ...
                $$ \overline{A}_8^4 = 8^4 = 4096 $$
            answer: $ \overline{A}_8^4 = 4096 $
...
@task
    ...
    solution: |
        ...
        $$ \overline{A}_3^5 = 3^5 = 243 $$
    answer: $\overline{A}_3^5 = 243$
...
@task
    ...
    solution: |
        ...
        $$ \overline{A}_2^{10} = 2^{10} = 1024 $$
    answer: $\overline{A}_2^{10} = 1024$
...
@task
    ...
    solution: |
        ...
        $$ \overline{A}_2^{11} = 2^{11} = 2048 $$
    answer: $\overline{A}_2^{11} = 2048$
...
@task
    ...
    solution: |
        ...
        Приведем пример.
        Вот несколько комбинаций, которые идут в зачет в формуле $\overline{A}_5^3$:
        ...
        $$ \overline{A}_4^1 = 4^1 = 4 \qquad \overline{A}_4^2 = 4^2 = 16 \qquad \overline{A}_4^3 = 4^3 = 64 $$
...
@task
    ...
    solution: |
        ...
        $$ \overline{A}_{32}^1 = 32^1 = 32 \\ \overline{A}_{32}^2 = 32^2 = 1024 \\ \overline{A}_{32}^3 = 32^3 = 32 \ 768 $$
    ...
    answer: $$ \left(\overline{A}_{32}^1 + \overline{A}_{32}^2 + \overline{A}_{32}^3\right)\cdot \overline{A}_{10}^4 = 338 \ 240 \ 000$$
...
@task
    ...
    solution: |
        ...
        $$ \overline{A}_{2}^{32} = 2^{32} = 4 \ 294 \ 967 \ 296 $$
    answer: |
        $$ \overline{A}_{2}^{32} = 2^{32} = 4 \ 294 \ 967 \ 296 $$
...
@task
    ...
    solution: |
        ...
        $$ 125 \cdot 16 = 2000 $$
    answer: $\overline{A}_5^3 \cdot \overline{A}_4^2 = 2000$
...
@task
    ...
    solution: |
        ...
        $$ \overline{A}_2^4 - 1 = \underbrace{15}_{Утки} \qquad \overline{A}_2^2 - 1 = \underbrace{3}_{Гуси} $$
    ...
    answer: $$ \left(\overline{A}_2^3 - 1\right)\cdot \left(\overline{A}_2^4 - 1\right) \cdot \left(\overline{A}_2^2 - 1\right) = 315$$
...
@task
    ...
    solution: |
        Количество шестибуквенных слов, которые можно набрать из $32$ букв равно $\overline{A}_{32}^6$.
        ...
        Слов без буквы "а", то есть слов из $31$ букв всего $\overline{A}_{31}^6$.
        Для получения ответа надо вычесть из всех слов те, в которых совсем нет буквы "а":

        $$ \overline{A}_{32}^6 - \overline{A}_{31}^6 = 32^6 - 31^6 = 186 \ 238 \ 143 $$
    answer: |
        $$ \overline{A}_{32}^6 - \overline{A}_{31}^6 = 32^6 - 31^6 = 186 \ 238 \ 143 $$
...
@task
    ...
    solution: |
        ...
        Сделать это он может $A_8^1$ способами если у каждого сына не может быть больше одного апельсина и $\overline{A}_8^1$, есть ограничений нет.
        Объединяем с предыдущим результатом:

        $$ 1 + A_8^1 \qquad 1 + \overline{A}_8^1 $$

        Отец может решить отдать только два апельсина.
        Сделать это он может $A_8^2$ способами если у каждого сына не может быть больше одного апельсина и $\overline{A}_8^2$, есть ограничений нет.
        Объединяем с предыдущим результатом:

        $$ 1 + A_8^1 + A_8^2 \qquad 1+ \overline{A}_8^1 + \overline{A}_8^2 $$
        ...
        @math
            ...
            \\
            1 + \overline{A}_8^1 + \overline{A}_8^2 + \overline{A}_8^3 + \overline{A}_8^4 + \overline{A}_8^5 = 37 \ 449
    answer: |
...
@task
    ...
    solution: |
        ...
        $$ \overline{A}_{10}^3 = 10^3 =  \underset{Судья \ 1}{\undergroup{10}} \cdot \underset{Судья \ 2}{\undergroup{10}} \cdot \underset{Судья \ 3}{\undergroup{10}} = 1000 $$
...
@task
    ...
    solution: |
        ...
        $$ \overline{A}_{13}^4 = 13^4 = \underset{Пики}{\undergroup{13}} \cdot \underset{Черви}{\undergroup{13}} \cdot \underset{Бубны}{\undergroup{13}} \cdot \underset{Трефы}{\undergroup{13}} = 28 \ 561 $$
    ...
    answer: |
        $\overline{A}_{13}^4 = 28 \ 561$ способов выбрать $4$ карты разных мастей и $A_{13}^4 = 17 \ 160$ способов выбрать их без повторений.
...
@task
    ...
    solution: |
        ...
        $$ \overline{A}_4^2 = 4^2 = \underset{Сотни}{\undergroup{4}} \cdot \underset{Десятки}{\undergroup{4}} = 16 $$
...
@task
    ...
    solution: |
        ...
        $$ \overline{A}_5^2 \cdot 5 = 25 \cdot 5 = 125 $$
    ...
    answer: |
        Если цифры могут повторяться: $ \overline{A}_5^2 \cdot 5  = 125 $.
        <br>
...
@todo
    ...
    content: |
        Сколькими разными способами (с учетом положения) можно разложить число $n$ на слагаемые?
...
@todo
    title: Шары по коробкам
    content: |
        Есть $n$ коробок и $m$ шаров.
        Сколькими способами можно разными способами распихать шары по коробкам.
        Порядок коробок значения не имеет.