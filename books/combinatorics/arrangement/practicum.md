...
@task
    ...
    solution: |
        ...
        $$ \bar{A}_2^{10} = 2^{10} = 1024 $$
    answer: $\bar{A}_2^{10} = 1024$
...
@task
    ...
    solution: |
        ...
        $$ \bar{A}_2^{11} = 2^{11} = 2048 $$
    answer: $\bar{A}_2^{11} = 2048$
...
@task
    ...
    solution: |
        ...
        Приведем пример.
        Вот несколько комбинаций, которые идут в зачет в формуле $\bar{A}_5^3$:
        ...
        $$ \bar{A}_4^1 = 4^1 = 4 \qquad \bar{A}_4^2 = 4^2 = 16 \qquad \bar{A}_4^3 = 4^3 = 64 $$
...
@task
    ...
    solution: |
        ...
        $$ \bar{A}_{32}^1 = 32^1 = 32 \\ \bar{A}_{32}^2 = 32^2 = 1024 \\ \bar{A}_{32}^3 = 32^3 = 32 \ 768 $$
    ...
    answer: $$ \left(\bar{A}_{32}^1 + \bar{A}_{32}^2 + \bar{A}_{32}^3\right)\cdot \bar{A}_{10}^4 = 338 \ 240 \ 000$$
...
@task
    ...
    solution: |
        ...
        $$ \bar{A}_{2}^{32} = 2^{32} = 4 \ 294 \ 967 \ 296 $$
    answer: |
        $$ \bar{A}_{2}^{32} = 2^{32} = 4 \ 294 \ 967 \ 296 $$
...
@task
    ...
    solution: |
        ...
        $$ 125 \cdot 16 = 2000 $$
    answer: $\bar{A}_5^3 \cdot \bar{A}_4^2 = 2000$
...
@task
    ...
    solution: |
        ...
        $$ \bar{A}_2^4 - 1 = \underbrace{15}_{Утки} \qquad \bar{A}_2^2 - 1 = \underbrace{3}_{Гуси} $$
    ...
    answer: $$ \left(\bar{A}_2^3 - 1\right)\cdot \left(\bar{A}_2^4 - 1\right) \cdot \left(\bar{A}_2^2 - 1\right) = 315$$
...
@task
    ...
    solution: |
        Количество шестибуквенных слов, которые можно набрать из $32$ букв равно $\bar{A}_{32}^6$.
        ...
        Слов без буквы "а", то есть слов из $31$ букв всего $\bar{A}_{31}^6$.
        Для получения ответа надо вычесть из всех слов те, в которых совсем нет буквы "а":

        $$ \bar{A}_{32}^6 - \bar{A}_{31}^6 = 32^6 - 31^6 = 186 \ 238 \ 143 $$
    answer: |
        $$ \bar{A}_{32}^6 - \bar{A}_{31}^6 = 32^6 - 31^6 = 186 \ 238 \ 143 $$
...
@task
    ...
    solution: |
        ...
        Сделать это он может $A_8^1$ способами если у каждого сына не может быть больше одного апельсина и $\bar{A}_8^1$, есть ограничений нет.
        Объединяем с предыдущим результатом:

        $$ 1 + A_8^1 \qquad 1 + \bar{A}_8^1 $$

        Отец может решить отдать только два апельсина.
        Сделать это он может $A_8^2$ способами если у каждого сына не может быть больше одного апельсина и $\bar{A}_8^2$, есть ограничений нет.
        Объединяем с предыдущим результатом:

        $$ 1 + A_8^1 + A_8^2 \qquad 1+ \bar{A}_8^1 + \bar{A}_8^2 $$
        ...
        @math
            ...
            \\
            1 + \bar{A}_8^1 + \bar{A}_8^2 + \bar{A}_8^3 + \bar{A}_8^4 + \bar{A}_8^5 = 37 \ 449
    answer: |
...
@task
    ...
    solution: |
        ...
        $$ \bar{A}_{10}^3 = 10^3 =  \underset{Судья \ 1}{\undergroup{10}} \cdot \underset{Судья \ 2}{\undergroup{10}} \cdot \underset{Судья \ 3}{\undergroup{10}} = 1000 $$
...
@task
    ...
    solution: |
        ...
        $$ \bar{A}_{13}^4 = 13^4 = \underset{Пики}{\undergroup{13}} \cdot \underset{Черви}{\undergroup{13}} \cdot \underset{Бубны}{\undergroup{13}} \cdot \underset{Трефы}{\undergroup{13}} = 28 \ 561 $$
    ...
    answer: |
        $\bar{A}_{13}^4 = 28 \ 561$ способов выбрать $4$ карты разных мастей и $A_{13}^4 = 17 \ 160$ способов выбрать их без повторений.
...
@task
    ...
    solution: |
        ...
        $$ \bar{A}_4^2 = 4^2 = \underset{Сотни}{\undergroup{4}} \cdot \underset{Десятки}{\undergroup{4}} = 16 $$
...
@task
    ...
    solution: |
        ...
        $$ \bar{A}_5^2 \cdot 5 = 25 \cdot 5 = 125 $$
    ...
    answer: |
        Если цифры могут повторяться: $ \bar{A}_5^2 \cdot 5  = 125 $.
        <br>
